  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row mt-10 px-4">
        <div className="w-full sm:w-1/2 flex flex-col text-yellow-400 bg-black p-4 rounded-lg">
          ...
          <div className="mb-4">
            ...
            <p className="text-lg">1234 Main St, Anytown, USA</p>
          </div>
        </div>

        <div className="w-full sm:w-1/2 ml-0 sm:ml-10 mt-10 sm:mt-0">
