  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center relative">
        ...
        <div className="absolute text-4xl text-yellow-300 font-bold text-center w-full h-full flex flex-col justify-center items-center bg-black bg-opacity-55">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-5 mx-5">
        <div className="sm:w-1/2 mt-4 sm:mt-0 e p-8 h-full sm:border sm:border-white ">
          <span className="text-3xl font-bold text-center sm:text-left mt-4 text-white ">Welcome</span>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center h-full">
        ...
        <div className="sm:w-1/2 mt-4 sm:mt-0  gap-5 mx-5 bg-black p-8 h-full hidden sm:block sm:border sm:border-white">
         <div>
          <h2 className="text-3xl font-bold text-center sm:text-left mt-4 text-white">Chapter</h2>
          <h2 className="mt-4 text-center text-yellow-300">
            The Shadow Riders Motorcycle Club was founded in 1984 by a group of
        ...
        <div className="sm:w-1/2 block sm:hidden mt-4">
          <Image 
            src="/soa3.jpg" 
            width={1000} height={500} 
            alt="soa"
